...
public static class TestDataGenerators
{
    ...
    ///     Note: PostgreSQL requires UTC offset for timestamp with time zone columns.
    /// </summary>
    public static Faker<User> CreateUserFaker()
    {
        return new Faker<User>()
              ...
              .RuleFor(u => u.LastChangePassword, f => f.Date.PastOffset(1).ToUniversalTime())
              .RuleFor(u => u.ModifiedDate, f => f.Date.RecentOffset(30).ToUniversalTime())
    ...
    public static Faker<UserGroup> CreateUserGroupFaker()
    {
        return new Faker<UserGroup>()
              ...
              .RuleFor(g => g.CreatedDate, f => f.Date.PastOffset(2).ToUniversalTime())
              .RuleFor(g => g.ModifiedDate, f => f.Date.RecentOffset(30).ToUniversalTime())

...
internal partial class SqlQueryBuilder
{
    ...
    private  List<string> TableNames       { get; } = [];
    private  List<string> JoinExpressions  { get; } = [];
    private  List<string> SelectionList    { get; } = [];
    private  List<string> WhereConditions  { get; } = [];
    private  List<string> OrderByList      { get; } = [];
    private  List<string> GroupByList      { get; } = [];
    private  List<string> HavingConditions { get; } = [];
    internal List<string> SplitColumns     { get; } = [];
